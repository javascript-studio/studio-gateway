...
exports.create = function (options = {}) {
  ...
  const integrations = {};
  Object.keys(swagger.paths).forEach((resource) => {
    integrations[resource] = {};
    Object.keys(swagger.paths[resource]).forEach((method) => {
      const config = swagger.paths[resource][method];
      let fn;
      try {
        ...
        e.message = `[${method.toUpperCase()} ${resource}] ${e.message}`;
        throw e;
      }
      ...
      integrations[resource][method] = fn;
    });
  });
